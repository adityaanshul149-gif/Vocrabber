...
export const PracticeScreen: React.FC<PracticeScreenProps> = ({
  ...
  return (
    <div className={`min-h-screen font-sans flex flex-col justify-start p-4 sm:p-6 max-w-md mx-auto pb-8 transition-colors ${
      isLvl2 ? 'bg-[#0B0F19] text-slate-100' : 'bg-[#FFFDF5] dark:bg-slate-950 text-slate-900 dark:text-slate-100'
    }`}>
      {/* Top Header Bar */}
      <div className={`flex items-center justify-between border-b-2.5 pb-2.5 mb-2.5 ${
      ...
      <div className={`rounded-2xl p-4 sm:p-5 border-3 space-y-3 mb-2 relative transition-all ${
        isLvl2
      ...
      {isAnswered && !isCorrect && isDontKnow && (
        <div className="bg-[#FFE600] text-black border-2.5 border-black rounded-2xl p-3.5 mb-3 flex items-center justify-between gap-3 shadow-[3.5px_3.5px_0px_0px_#000] animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <button
            type="button"
            onClick={handleRetry}
            className="px-4 py-2.5 bg-[#A855F7] hover:bg-[#9333EA] text-white border-2 border-black font-black text-xs uppercase rounded-xl shadow-[2px_2px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none cursor-pointer flex items-center gap-1.5 shrink-0"
          >
      ...
      {isAnswered && !isCorrect && !isDontKnow && (
        <div className="bg-[#FF6B6B] text-black border-2.5 border-black rounded-2xl p-3.5 mb-3 flex items-center justify-between gap-3 shadow-[3.5px_3.5px_0px_0px_#000] animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="flex items-center gap-2.5">
          ...
          <button
            type="button"
            onClick={handleRetry}
            className="px-4 py-2.5 bg-[#FFE600] hover:bg-[#FFD700] text-black border-2 border-black font-black text-xs uppercase rounded-xl shadow-[2px_2px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none cursor-pointer flex items-center gap-1.5 shrink-0"
          >
            <RotateCcw className="w-4 h-4 stroke-[2.5]" />
            Try Again
          </button>
